 ...
 push eax
 push ebx
 push ecx                 ; KONWENCJA C - musimy zachować oryginalne dane z rejestru EBX
 ...
 fld a           ; stack: a, sin(P*2pix), 2pix, x, int
 fmul ST1        ; stack: a*sin(...), sin(P*2pix), 2pix, x, int
 ...
 fld b 
 fmul ST1        ; stack: b*sin(...), sin(Q*2pix), a*..., 2pix, x, int
